...
var require_path_finder = __commonJS({
  "../Shaku/lib/utils/path_finder.js"(exports, module) {
    ...
    function findPath(grid2, startPos, targetPos, options) {
      let ret = _ImpFindPath(grid2, startPos, targetPos, options || {});
      return ret;
    }
    function _ImpFindPath(grid2, startPos, targetPos, options) {
      ...
      while (openSet.length > 0) {
        ...
        for (let neighbor of neighbors) {
          if (closedSet.has(neighbor) || grid2.isBlocked(currentNode.position, neighbor.position)) {
            continue;
          }
          let price = options.ignorePrices ? 1 : grid2.getPrice(neighbor.position);
  ...
  "../Shaku/lib/gfx/matrix.js"(exports, module) {
    ...
    var Matrix = class {
      ...
      static transformVertex(matrix, vertex) {
        return new Vertex2(Matrix.transformVector2(matrix, vertex.position), vertex.textureCoord, vertex.color);
      }
...
void main(void) {
    ...
    `;
    var BasicEffect2 = class extends Effect2 {
      get vertexCode() {
        return vertexShader;
      }
      get fragmentCode() {
...
var require_msdf_font_texture_asset = __commonJS({
  "../Shaku/lib/assets/msdf_font_texture_asset.js"(exports, module) {
    ...
    var TextureFilterModes2 = require_texture_filter_modes();
  ...
  "../Shaku/lib/gfx/sprite_batch.js"(exports, module) {
    ...
    var SpriteBatch = class {
      constructor(gfx2) {
        this._gfx = gfx2;
        this._gl = gfx2._gl;
        this._positions = gfx2._dynamicBuffers.positionArray;
        this._uvs = gfx2._dynamicBuffers.textureArray;
        this._colors = gfx2._dynamicBuffers.colorsArray;
        this._positionsBuff = gfx2._dynamicBuffers.positionBuffer;
        this._uvsBuff = gfx2._dynamicBuffers.textureCoordBuffer;
        this._colorsBuff = gfx2._dynamicBuffers.colorsBuffer;
        this._indexBuff = gfx2._dynamicBuffers.indexBuffer;
        this.snapPixels = true;
        this.applyAntiBleeding = true;
      }
      vertex(position, textureCoord, color) {
        return new Vertex2(position, textureCoord, color);
      }
      get drawing() {
...
var require_gfx = __commonJS({
  "../Shaku/lib/gfx/gfx.js"(exports, module) {
    ...
    var { BlendMode, BlendModes: BlendModes2 } = require_blend_modes();
    var Rectangle = require_rectangle();
    var { Effect: Effect2, BasicEffect: BasicEffect2, MsdfFontEffect } = require_effects();
    var TextureAsset = require_texture_asset();
    var { TextureFilterMode, TextureFilterModes: TextureFilterModes2 } = require_texture_filter_modes();
    var { TextureWrapMode, TextureWrapModes } = require_texture_wrap_modes();
    ...
    var Gfx = class extends IManager {
      ...
      setup() {
        return new Promise(async (resolve, reject2) => {
          ...
          this.builtinEffects.Basic = this.createEffect(BasicEffect2);
  ...
  "../Shaku/lib/collision/shapes/circle.js"(exports, module) {
    ...
    var CircleShape = class extends CollisionShape {
      ...
      debugDraw(opacity) {
        ...
        let color = this._getDebugColor();
        color.a *= opacity;
        gfx2.outlineCircle(this._circle, color, gfx2.BlendModes.AlphaBlend, 14);
        color.a *= 0.25;
        gfx2.fillCircle(this._circle, color, gfx2.BlendModes.AlphaBlend, 14);
      }
    };
      ...
      debugDraw(gridColor, gridHighlitColor, opacity, camera) {
        ...
        for (let i = minx; i <= maxx; ++i) {
          for (let j = miny; j <= maxy; ++j) {
            ...
            gfx2.outlineRect(cellRect, color, gfx2.BlendModes.AlphaBlend, 0);
            if (cell) {
              for (let shape of cell) {
  ...
  "../Shaku/lib/collision/shapes/rectangle.js"(exports, module) {
    ...
    var RectangleShape = class extends CollisionShape {
      ...
      debugDraw(opacity) {
        ...
        let color = this._getDebugColor();
        color.a *= opacity;
        gfx2.outlineRect(this._rect, color, gfx2.BlendModes.AlphaBlend);
        color.a *= 0.25;
        gfx2.fillRect(this._rect, color, gfx2.BlendModes.AlphaBlend);
      }
    };
  ...
  "../Shaku/lib/collision/shapes/lines.js"(exports, module) {
    ...
    var LinesShape = class extends CollisionShape {
      ...
      debugDraw(opacity) {
        ...
        color.a *= opacity;
        for (let i = 0; i < this._lines.length; ++i) {
          gfx2.drawLine(this._lines[i].from, this._lines[i].to, color, gfx2.BlendModes.AlphaBlend);
        }
      }
    };
    ...
    var TilemapShape = class extends CollisionShape {
      ...
      debugDraw(opacity) {
        ...
        if (this._haveBorders) {
          gfx2.outlineRect(this._intBoundingRect, color, gfx2.BlendModes.AlphaBlend);
          gfx2.outlineRect(this._boundingRect, color, gfx2.BlendModes.AlphaBlend);
        }
...
var require_shaku = __commonJS({
  "../Shaku/lib/shaku.js"(exports, module) {
    ...
    var gfx2 = isBrowser ? require_gfx2() : null;
    var input2 = isBrowser ? require_input2() : null;
    ...
    var Shaku2 = class {
      ...
      async init(managers) {
        return new Promise(async (resolve, reject2) => {
          ...
          GameTime.reset();
          _usedManagers = managers || (isBrowser ? [assets, sfx, gfx2, input2, collision] : [assets, collision]);
...
var require_lib = __commonJS({
  "../Shaku/lib/index.js"(exports, module) {
    "use strict";
    module.exports = require_shaku();
  }
});
...
var import_gfx2 = __toESM(require_gfx2());
...
var DIRS = [
  ...
  import_vector2.default.left,
  import_vector2.default.up
];
var DI = [1, 0, -1, 0];
var DJ = [0, 1, 0, -1];
var DI_CORNER = [1, 0, 0, 1];
var DJ_CORNER = [1, 1, 0, 0];
function oppDir(dir) {
  return (2 + dir) % 4;
}
function rotateDir(dir, by) {
  return (dir + by) % 4;
}
...
var Tile = class {
  constructor(i, j, car = null) {
    ...
    this.sprites = makeRectArrayFromFunction(RESOLUTION, RESOLUTION, (i2, j2) => {
      let sprite = new import_sprite.default(cars_texture);
      sprite.static = true;
      let uv_top_left = new import_vector2.default(i2 / RESOLUTION, j2 / RESOLUTION);
      let uv_bottom_right = new import_vector2.default((i2 + 1) / RESOLUTION, (j2 + 1) / RESOLUTION);
      sprite._cachedVertices = [
        new import_gfx2.Vertex(this.verts[j2][i2], uv_top_left),
  ...
  updateSprites() {
    let temp_frame = new Frame(this, import_vector2.default.zero, 0);
  ...
  drawSprites() {
    ...
    import_shaku.default.gfx.spritesBatch.end();
  }
  invBilinear(screen_pos) {
    ...
    let k2 = import_vector2.default.cross(g, f);
    let k1 = import_vector2.default.cross(e, f) + import_vector2.default.cross(h, g);
    let k0 = import_vector2.default.cross(h, e);
    if (Math.abs(k2) < 1e-3) {
      ...
      return new import_vector2.default(u, v);
    } else {
      let w = k1 * k1 - 4 * k0 * k2;
      if (w < 0)
        return null;
...
function step() {
  ...
  if (dragging === null) {
    ...
    if (import_shaku2.input.mouseReleased()) {
      ...
      let forward = grid.frame2screen(cur_mouse_frame.clone().move(0, 0.05) || cur_mouse_frame);
      let backward = grid.frame2screen(cur_mouse_frame.clone().move(2, 0.05) || cur_mouse_frame);
